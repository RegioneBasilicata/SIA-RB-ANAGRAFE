...
public class ImportaSoggettiAaepCU extends Autorizzazione
{
	/**
	 * 
	 */
	private static final long serialVersionUID = 5282146249953370066L;

	public ImportaSoggettiAaepCU()
	{
		this.cuName="IMPORTA_SOGGETTI_AAEP";
	...
	public String writeMenu(Htmpl htmpl, HttpServletRequest request) {
		...
		Azienda impresaInfoc = (Azienda)request.getSession().getAttribute("impresaInfoc");
		...
		if(impresaInfoc != null && super.hasPropertiesToModifyAnagrafe(ruoloUtenza, anagAziendaVO)) {
			htmpl.newBlock("blkImportaSoggettiAAEPButtons");
		}
		return null;
