...
public class RegistroDebitoriCU extends Autorizzazione
{
   ...
   * 
   */
  private static final long serialVersionUID = -1148907193642941127L;

  public RegistroDebitoriCU()
	{
		this.cuName="REGISTRO_DEBITORI";
