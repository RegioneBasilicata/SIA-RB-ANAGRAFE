...
public class RichiestaAziendaCU extends Autorizzazione
{
	/**
	 * 
	 */
	private static final long serialVersionUID = 8186045901829889405L;

	public RichiestaAziendaCU()
	{
		this.cuName="RICHIESTA_AZIENDA";
			...
			AnagFacadeClient anagFacadeClient)
	{
	  ...
	  if(iride2AbilitazioniVO.isUtenteAbilitato("INSERISCI_CHIUNQUE"))
      request.setAttribute("inserisciChiunque", "true");
