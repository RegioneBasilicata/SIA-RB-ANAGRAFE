...
public class VisualizzaManodoperaCU extends AutorizzazioneCUStandard
{
	/**
	 * 
	 */
	private static final long serialVersionUID = 4532832854451605692L;

	public VisualizzaManodoperaCU()
	{
		this.cuName="VISUALIZZA_MANODOPERA";
  ...
  public String writeMenu(Htmpl htmpl, HttpServletRequest request) {
		...
		Object objForMenu = (Vector)request.getAttribute("elencoManodopera");
		if(objForMenu == null) {
			objForMenu = (ManodoperaVO)request.getAttribute("manodoperaVO");
		}

		super.writeBanner(htmpl, request);
		super.writeBarraDatiAzienda(anagAziendaVO, htmpl);
		super.writeBarraStato(sex, htmpl);
		super.writeGenericMenu(ruoloUtenza, anagAziendaVO, htmpl, "blkManodopera", objForMenu, "getDataFineValiditaDate", request);
