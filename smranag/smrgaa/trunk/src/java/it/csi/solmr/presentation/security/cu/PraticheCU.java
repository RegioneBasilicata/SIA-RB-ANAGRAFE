...
public class PraticheCU extends Autorizzazione
{
	/**
	 * 
	 */
	private static final long serialVersionUID = 1388791644216030027L;

	public PraticheCU()
	{
		this.cuName="PRATICHE";
    ...
    if (iride2AbilitazioniVO.isUtenteAbilitato("POLIZZE"))
      htmpl.newBlock("blkPratiche.blkPolizze");
    
    if (iride2AbilitazioniVO.isUtenteAbilitato("REGISTRO_DEBITORI"))
      htmpl.newBlock("blkPratiche.blkRegistroDebitori");
    
    if (iride2AbilitazioniVO.isUtenteAbilitato("BUONI_CARBURANTE"))
      htmpl.newBlock("blkPratiche.blkBuoniCarburante");
