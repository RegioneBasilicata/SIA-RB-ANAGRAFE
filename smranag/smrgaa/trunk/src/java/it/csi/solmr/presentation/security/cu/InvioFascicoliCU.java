...
public class InvioFascicoliCU extends Autorizzazione {
   ...
   * 
   */
  private static final long serialVersionUID = -1778164163715608484L;
  
  
  

  public InvioFascicoliCU() {
		this.cuName="INVIO_FASCICOLI";
