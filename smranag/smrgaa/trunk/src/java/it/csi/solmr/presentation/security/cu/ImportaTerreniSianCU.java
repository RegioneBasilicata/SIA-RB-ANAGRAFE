...
public class ImportaTerreniSianCU extends Autorizzazione
{
	/**
	 * 
	 */
	private static final long serialVersionUID = -2130998994458794635L;

	public ImportaTerreniSianCU()
	{
		this.cuName="IMPORTA_TERRENI_SIAN";
