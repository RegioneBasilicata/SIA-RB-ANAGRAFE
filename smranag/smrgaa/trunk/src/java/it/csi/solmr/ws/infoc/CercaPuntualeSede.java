...
@XmlRootElement(name = "cercaPuntualeSede", namespace = "http://servizio.frontend.ls.com")
public class CercaPuntualeSede {
    ...
    @XmlElementRef(name = "progrSede", namespace = "http://servizio.frontend.ls.com", type = JAXBElement.class, required = false)
