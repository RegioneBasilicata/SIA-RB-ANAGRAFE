...
public class VisualizzaSoggettiAaepCU extends Autorizzazione
{
	/**
	 * 
	 */
	private static final long serialVersionUID = -2037195007654548984L;

	public VisualizzaSoggettiAaepCU()
	{
		this.cuName="VISUALIZZA_SOGGETTI_AAEP";
