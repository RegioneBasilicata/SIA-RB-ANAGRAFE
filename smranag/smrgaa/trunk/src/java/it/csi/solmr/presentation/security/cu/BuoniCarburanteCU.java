...
public class BuoniCarburanteCU extends Autorizzazione
{
   ...
   * 
   */
  private static final long serialVersionUID = -4448694362987305014L;
  
  

  public BuoniCarburanteCU()
	{
		this.cuName="BUONI_CARBURANTE";
