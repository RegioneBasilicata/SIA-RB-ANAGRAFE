...
public class ReportisticaCU extends Autorizzazione
{
	/**
	 * 
	 */
	private static final long serialVersionUID = -5826402097755723340L;

	public ReportisticaCU()
	{
		this.cuName="REPORTISTICA";
