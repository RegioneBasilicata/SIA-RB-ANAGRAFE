...
public class RicercaTerrenoSigmaterCU extends Autorizzazione
{
   ...
   * 
   */
  private static final long serialVersionUID = 2994267967257604930L;
  
  

  public RicercaTerrenoSigmaterCU()
	{
		this.cuName="RICERCA_TERRENO_SIGMATER";
