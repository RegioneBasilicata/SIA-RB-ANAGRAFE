...
@XmlRootElement(name = "cercaPuntualePersonaRI", namespace = "http://servizio.frontend.ls.com")
public class CercaPuntualePersonaRI {
    ...
    @XmlElementRef(name = "progrPersona", namespace = "http://servizio.frontend.ls.com", type = JAXBElement.class, required = false)
