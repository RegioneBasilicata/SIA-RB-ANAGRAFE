...
public class GestioneManodoperaCU extends AutorizzazioneCUStandard {
	/**
	 * 
	 */
	private static final long serialVersionUID = -4789293436710686684L;

	public GestioneManodoperaCU() {
		this.cuName = "GESTIONE_MANODOPERA";
  ...
  public String writeMenu(Htmpl htmpl, HttpServletRequest request) {
		...
		super.writeGenericMenu(ruoloUtenza, anagAziendaVO, htmpl, "blkManodopera", objForMenu, null, request);
		return null;
	}
