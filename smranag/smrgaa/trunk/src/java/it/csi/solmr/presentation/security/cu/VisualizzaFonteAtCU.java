...
public class VisualizzaFonteAtCU extends AutorizzazioneCUStandard
{
  /**
   * 
   */
  private static final long serialVersionUID = 8668845419528761048L;

  public VisualizzaFonteAtCU()
  {
    this.cuName = "VISUALIZZA_FONTE_AT";
