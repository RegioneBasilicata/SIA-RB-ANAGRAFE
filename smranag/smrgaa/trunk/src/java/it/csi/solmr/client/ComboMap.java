...
public class ComboMap extends AbstractMap<Object,Object>
	             implements SortedMap<Object,Object>, Cloneable, java.io.Serializable
{
  ...
  private Comparator<Object> comparator = null;
     ...
     */
    public ComboMap(Comparator<Object> c) {
        this.comparator = c;
    }
    ...
    public ComboMap(SortedMap<Object,Object> m) {
        comparator = (Comparator<Object>) m.comparator();
        try {
    ...
    /**
     * Removes the mapping for this key from this ComboMap if present.
     *
     * @return previous value associated with specified key, or <tt>null</tt>
     *	       if there was no mapping for key.  A <tt>null</tt> return can
    ...
    /**
     * Removes all mappings from this ComboMap.
     */
    public void clear() {
        modCount++;
        size = 0;
    ...
    /**
     * Returns a shallow copy of this <tt>ComboMap</tt> instance. (The keys and
    ...
    private transient Set<Object>		entrySet = null;
     ...
     * this <tt>ComboMap</tt> instance, so changes to this map are reflected in
     ...
     *
     * @return a set view of the keys contained in this ComboMap.
     */
     ...
     * mapping from the ComboMap, through the <tt>Iterator.remove</tt>,
    ...
    public Set entrySet() {
        if (entrySet == null) {
            entrySet = new AbstractSet<Object>() {
                public java.util.Iterator<Object> iterator() {
    ...
    private class SubMap extends AbstractMap<Object,Object>
                             implements SortedMap<Object,Object>, java.io.Serializable {
        ...
        public boolean containsKey(Object key) {
            return inRange(key) && ComboMap.this.containsKey(key);
        }

        public Object get(Object key) {
            if (!inRange(key))
                return null;
            return ComboMap.this.get(key);
        }

        public Object put(Object key, Object value) {
            if (!inRange(key))
                throw new IllegalArgumentException("key out of range");
            return ComboMap.this.put(key, value);
        }
        ...
        private class EntrySetView extends AbstractSet<Object> {
            ...
            public int size() {
                if (size == -1 || sizeModCount != ComboMap.this.modCount) {
                    size = 0;  sizeModCount = ComboMap.this.modCount;
            ...
            public boolean contains(Object o) {
                ...
                if (!inRange(key))
                    return false;
                ComboMap.Entry node = getEntry(key);
                return node != null &&
    ...
    private class Iterator implements java.util.Iterator<Object> {
        private int type;
        private int expectedModCount = ComboMap.this.modCount;
    ...
    /**
     * Compares two keys using the correct comparison method for this ComboMap.
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * Returns the first Entry in the ComboMap (according to the ComboMap's
     * key-sort function).  Returns null if the ComboMap is empty.
     */
    ...
    /**
     * Returns the last Entry in the ComboMap (according to the ComboMap's
     * key-sort function).  Returns null if the ComboMap is empty.
     */
    ...
    /**
     * Save the state of the <tt>ComboMap</tt> instance to a stream (i.e.,
     * serialize it).
     *
     * @serialData The <i>size</i> of the ComboMap (the number of key-value
     *		   mappings) is emitted (int), followed by the key (Object)
     *		   and value (Object) for each key-value mapping represented
     *		   by the ComboMap. The key-value mappings are emitted in
     *		   key-order (as determined by the ComboMap's Comparator,
     *		   or by the keys' natural ordering if the ComboMap has no
     *             Comparator).
     */
    ...
    /**
     * Reconstitute the <tt>ComboMap</tt> instance from a stream (i.e.,
     * deserialize it).
     */
     ...
     *
     * It is assumed that the comparator of the ComboMap is already set prior
     ...
     * It is assumed that the comparator and size fields of the ComboMap are
    ...
    public class OrdinamentoComboForCodice implements Comparator<Object> {
