...
public class VisualizzaDatiAziendaCU extends AutorizzazioneCUStandard
{
	/**
	 * 
	 */
	private static final long serialVersionUID = 5872937984686438876L;


	public VisualizzaDatiAziendaCU()
	{
		this.cuName="VISUALIZZA_DATI_AZIENDA";
  ...
  public String writeMenu(Htmpl htmpl, HttpServletRequest request) {
		SolmrLogger.debug(this, "Invocating method writeMenu in VisualizzaDatiAziendaCU\n");
		...
		SolmrLogger.debug(this, "Value of parameter[V_SOGGETTI] method writeMenu in VisualizzaDatiAziendaCU: "+request.getSession().getAttribute("v_soggetti")+"\n");
		SolmrLogger.debug(this, "Value of parameter[V_UTE] method writeMenu in VisualizzaDatiAziendaCU: "+request.getSession().getAttribute("v_ute")+"\n");
		SolmrLogger.debug(this, "Value of parameter[PERSONA_VO] method writeMenu in VisualizzaDatiAziendaCU: "+request.getAttribute("personaVO")+"\n");
		SolmrLogger.debug(this, "Value of parameter[UTE_VO] method writeMenu in VisualizzaDatiAziendaCU: "+request.getSession().getAttribute("uteVO")+"\n");
      ...
      htmpl.newBlock("blkModificaGestoreFascicolo");
		...
		SolmrLogger.debug(this, "Invocated method writeMenu in VisualizzaDatiAziendaCU\n");
		return null;
	}
