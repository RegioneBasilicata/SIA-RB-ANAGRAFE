...
public class VisualizzaBdnCU extends Autorizzazione
{
	/**
	 * 
	 */
	private static final long serialVersionUID = 9061611157355720230L;

	public VisualizzaBdnCU()
	{
		this.cuName="VISUALIZZA_BDN";
	...
	public String writeMenu(Htmpl htmpl, HttpServletRequest request) 
	{
		...
		/*if(elencoAllevamentiSian != null) {
			...
			{
				if(elencoAllevamentiSian != null && elencoAllevamentiSian.size() > 0) {
