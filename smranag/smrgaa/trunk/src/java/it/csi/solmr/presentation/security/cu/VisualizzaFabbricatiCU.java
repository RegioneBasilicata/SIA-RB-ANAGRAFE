...
public class VisualizzaFabbricatiCU extends AutorizzazioneCUStandard
{
	/**
	 * 
	 */
	private static final long serialVersionUID = 2286544921606249829L;

	public VisualizzaFabbricatiCU()
	{
		this.cuName="VISUALIZZA_FABBRICATI";
	...
	public String writeMenu(Htmpl htmpl, HttpServletRequest request) {
		...
		Object objForMenu = (FabbricatoVO[])request.getAttribute("elencoFabbricati");
		if(objForMenu == null) {
		...
		super.writeGenericMenu(ruoloUtenza, anagAziendaVO, htmpl, "blkFabbricati", objForMenu, "getDataFineValiditaFabbricato", request);
		return null;
	}
