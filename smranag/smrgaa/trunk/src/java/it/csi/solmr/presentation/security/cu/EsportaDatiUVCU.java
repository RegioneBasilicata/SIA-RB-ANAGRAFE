...
public class EsportaDatiUVCU extends Autorizzazione
{
   ...
   * 
   */
  private static final long serialVersionUID = 2515310024323053681L;
  
  

  public EsportaDatiUVCU()
	{
		this.cuName="ESPORTA_DATI_UV";
