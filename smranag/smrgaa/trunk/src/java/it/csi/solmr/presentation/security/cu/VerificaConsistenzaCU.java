...
public class VerificaConsistenzaCU extends Autorizzazione {
	
	private static final long serialVersionUID = 3842007069308419746L;

	public VerificaConsistenzaCU() {
		this.cuName="VERIFICA_CONSISTENZA";
