...
public class VisualizzaFonteAaepCU extends AutorizzazioneCUStandard
{
	/**
	 * 
	 */
	private static final long serialVersionUID = -6093976837016796785L;

	public VisualizzaFonteAaepCU()
	{
		this.cuName="VISUALIZZA_FONTE_AAEP";
