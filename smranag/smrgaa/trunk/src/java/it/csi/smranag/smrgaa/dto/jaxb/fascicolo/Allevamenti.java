 ...
 *       &lt;sequence>
 *         &lt;element ref="{}Allevamento" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "Allevamenti")
public class Allevamenti {

    @XmlElement(name = "Allevamento", required = true)
    protected List<Allevamento> allevamento;
     ...
     * 
     */
    public List<Allevamento> getAllevamento() {
        if (allevamento == null) {
            allevamento = new ArrayList<Allevamento>();
        }
