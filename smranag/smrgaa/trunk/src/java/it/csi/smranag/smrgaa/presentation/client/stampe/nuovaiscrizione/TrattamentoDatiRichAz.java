...
public class TrattamentoDatiRichAz extends SubReport
{
  private final static String TEMPLATE_NAME     = "/it/csi/solmr/etc/anag/stampe/nuovaiscrizione/TrattamentoDatiRichAz.srt";
  private final static String CODICE_SUB_REPORT = "TRATTAMENTO_DATI_RICH_AZ";

  public TrattamentoDatiRichAz() throws IOException, SolmrException
  {
