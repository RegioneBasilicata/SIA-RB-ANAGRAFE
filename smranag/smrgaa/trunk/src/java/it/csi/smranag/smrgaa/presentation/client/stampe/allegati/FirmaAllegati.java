...
public class FirmaAllegati extends SubReport
{
  private final static String TEMPLATE_NAME     = "/it/csi/solmr/etc/anag/stampe/allegati/FirmaAllegati.srt";
  private final static String CODICE_SUB_REPORT = "FIRMA_ALLEGATI";

  public FirmaAllegati() throws IOException, SolmrException
  {
      ...
      throws Exception
  {
    ...
    if (responsabile != null)
    {
      ...
      tblLuogoDataAmm.setColWidth(0, 212);
    ...
    tblLuogoDataProd.setColWidth(0, 212);
