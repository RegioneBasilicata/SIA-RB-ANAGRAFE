...
public class TerreniRiepilogoCond extends SubReportModol
{
      ...
      throws Exception
  {
    ...
    Vector<ConduzioneParticellaVO> terreni = gaaFacadeClient
      .getRiepilogoConduzioneStampa(anagAziendaVO.getIdAzienda(), codiceFotografia);
    ...
    {   
      ...
      for(int i=0;i<terreni.size();i++)
      {
        ...
        ConduzioneParticellaVO conduzioneParticellaVO = terreni.get(i);        
        rigaRiepilogo.setValore1(conduzioneParticellaVO.getTitoloPossesso().getDescription());
