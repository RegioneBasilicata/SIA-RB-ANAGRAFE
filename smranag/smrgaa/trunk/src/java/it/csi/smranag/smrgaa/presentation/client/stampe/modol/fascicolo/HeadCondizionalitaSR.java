...
public class HeadCondizionalitaSR extends SubReportModol
{
 
  private final static String CODICE_SUB_REPORT = "HEAD_CONDIZIONALITA";

  public HeadCondizionalitaSR() throws IOException, SolmrException
  {
      ...
      throws Exception
  {
    ...
    fascicoDigitale.getAllegati().setHeadCondizionalita(true);
