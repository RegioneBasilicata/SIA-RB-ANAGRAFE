 ...
 *       &lt;sequence>
 *         &lt;element ref="{}UTE" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ElencoUTE")
public class ElencoUTE {

    @XmlElement(name = "UTE", required = true)
    protected List<UTE> ute;
     ...
     * 
     */
    public List<UTE> getUTE() {
        if (ute == null) {
            ute = new ArrayList<UTE>();
        }
        return this.ute;
    }
