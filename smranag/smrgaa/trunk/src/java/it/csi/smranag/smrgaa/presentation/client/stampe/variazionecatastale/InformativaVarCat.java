...
public class InformativaVarCat extends SubReport
{
  private final static String TEMPLATE_NAME     = "/it/csi/solmr/etc/anag/stampe/variazionecatastale/InformativaVarCat.srt";
  private final static String CODICE_SUB_REPORT = "INFORMATIVA_VAR_CAT";

  public InformativaVarCat() throws IOException, SolmrException
  {
