...
public class Azienda extends SubReportModol
{
  ...
  {   
    ...
    if(Validator.isNotEmpty(anagAziendaVO.getTipoAttivitaATECO())
      && Validator.isNotEmpty(anagAziendaVO.getTipoAttivitaATECO().getDescription()))
    {
    ...
    Vector<TipoInfoAggiuntivaVO> vTipoInfoAggiuntiva = gaaFacadeClient
        .getTipoInfoAggiuntiveStampa(anagAziendaVO.getIdAzienda(), dataInserimentoDichiarazione);
