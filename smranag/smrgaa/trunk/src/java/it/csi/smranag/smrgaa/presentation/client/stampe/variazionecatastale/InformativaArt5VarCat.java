...
public class InformativaArt5VarCat extends SubReport
{
  private final static String TEMPLATE_NAME     = "/it/csi/solmr/etc/anag/stampe/variazionecatastale/InformativaArt5VarCat.srt";
  private final static String CODICE_SUB_REPORT = "INFORMATIVA_ART5_VAR_CAT";

  public InformativaArt5VarCat() throws IOException, SolmrException
  {
