...
public class Estratto2VarCat extends SubReport
{
  private final static String TEMPLATE_NAME     = "/it/csi/solmr/etc/anag/stampe/variazionecatastale/Estratto2VarCat.srt";
  private final static String CODICE_SUB_REPORT = "ESTRATTO2_VAR_CAT";

  public Estratto2VarCat() throws IOException, SolmrException
  {
