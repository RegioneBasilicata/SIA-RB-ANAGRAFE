...
public class TrattamentoDatiAllegati extends SubReport
{
  private final static String TEMPLATE_NAME     = "/it/csi/solmr/etc/anag/stampe/allegati/TrattamentoDatiAllegati.srt";
  private final static String CODICE_SUB_REPORT = "TRATTAMENTO_DATI_ALLEGATI";

  public TrattamentoDatiAllegati() throws IOException, SolmrException
  {
      ...
      throws Exception
  {
    ...
    tblLuogoDataPers.setColWidth(0, 212);
