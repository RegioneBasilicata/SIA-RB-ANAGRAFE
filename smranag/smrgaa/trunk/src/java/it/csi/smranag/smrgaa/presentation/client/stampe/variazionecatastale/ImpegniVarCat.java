...
public class ImpegniVarCat extends SubReport
{
  private final static String TEMPLATE_NAME     = "/it/csi/solmr/etc/anag/stampe/variazionecatastale/ImpegniVarCat.srt";
  private final static String CODICE_SUB_REPORT = "IMPEGNI_VAR_CAT";

  public ImpegniVarCat() throws IOException, SolmrException
  {
