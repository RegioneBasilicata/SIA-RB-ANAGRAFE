...
public class DocFirma extends SubReport
{
  private final static String TEMPLATE_NAME     = "/it/csi/solmr/etc/anag/stampe/documento/DocFirma.srt";
  private final static String CODICE_SUB_REPORT = "DOC_FIRMA";

  public DocFirma() throws IOException, SolmrException
  {
