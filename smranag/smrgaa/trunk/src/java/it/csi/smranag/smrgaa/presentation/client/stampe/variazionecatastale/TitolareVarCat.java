...
public class TitolareVarCat extends SubReport
{
  private final static String TEMPLATE_NAME     = "/it/csi/solmr/etc/anag/stampe/variazionecatastale/TitolareVarCat.srt";
  private final static String CODICE_SUB_REPORT = "TITOLARE_VAR_CAT";

  public TitolareVarCat() throws IOException, SolmrException
  {
