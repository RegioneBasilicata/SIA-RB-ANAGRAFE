...
public class Estratto1VarCat extends SubReport
{
  private final static String TEMPLATE_NAME     = "/it/csi/solmr/etc/anag/stampe/variazionecatastale/Estratto1VarCat.srt";
  private final static String CODICE_SUB_REPORT = "ESTRATTO1_VAR_CAT";

  public Estratto1VarCat() throws IOException, SolmrException
  {
