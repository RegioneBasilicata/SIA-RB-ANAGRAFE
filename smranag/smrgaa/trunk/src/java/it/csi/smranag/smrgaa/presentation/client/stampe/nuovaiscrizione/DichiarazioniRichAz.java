...
public class DichiarazioniRichAz extends SubReport
{
  private final static String TEMPLATE_NAME     = "/it/csi/solmr/etc/anag/stampe/nuovaiscrizione/DichiarazioniRichAz.srt";
  private final static String CODICE_SUB_REPORT = "DICHIARAZIONI_RICH_AZ";

  public DichiarazioniRichAz() throws IOException, SolmrException
  {
