...
public class DocTrattamentoDati extends SubReport
{
  private final static String TEMPLATE_NAME     = "/it/csi/solmr/etc/anag/stampe/documento/DocTrattamentoDati.srt";
  private final static String CODICE_SUB_REPORT = "DOC_TRATTAMENTO_DATI";

  public DocTrattamentoDati() throws IOException, SolmrException
  {
