...
public class DocDichiarazioni extends SubReport
{
  private final static String TEMPLATE_NAME     = "/it/csi/solmr/etc/anag/stampe/documento/DocDichiarazioni.srt";
  private final static String CODICE_SUB_REPORT = "DOC_DICHIARAZIONI";

  public DocDichiarazioni() throws IOException, SolmrException
  {
