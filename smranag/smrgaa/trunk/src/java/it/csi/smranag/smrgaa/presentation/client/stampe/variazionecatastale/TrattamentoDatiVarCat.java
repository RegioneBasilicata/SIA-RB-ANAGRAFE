...
public class TrattamentoDatiVarCat extends SubReport
{
  private final static String TEMPLATE_NAME     = "/it/csi/solmr/etc/anag/stampe/variazionecatastale/TrattamentoDatiVarCat.srt";
  private final static String CODICE_SUB_REPORT = "TRATTAMENTO_DATI_VAR_CAT";

  public TrattamentoDatiVarCat() throws IOException, SolmrException
  {
