...
public class Header10R extends SubReport
{
  private final static String TEMPLATE_NAME     = "/it/csi/solmr/etc/anag/stampe/comunicazione10r/Header10R.srt";
  private final static String CODICE_SUB_REPORT = "HEADER_10R";

  public Header10R() throws IOException, SolmrException
  {
