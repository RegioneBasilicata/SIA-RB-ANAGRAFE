...
public class AziendaVarCat extends SubReport
{
  private final static String TEMPLATE_NAME     = "/it/csi/solmr/etc/anag/stampe/variazionecatastale/AziendaVarCat.srt";
  private final static String CODICE_SUB_REPORT = "AZIENDA_VAR_CAT";

  public AziendaVarCat() throws IOException, SolmrException
  {
