...
public class InformativaArt3VarCat extends SubReport
{
  private final static String TEMPLATE_NAME     = "/it/csi/solmr/etc/anag/stampe/variazionecatastale/InformativaArt3VarCat.srt";
  private final static String CODICE_SUB_REPORT = "INFORMATIVA_ART3_VAR_CAT";

  public InformativaArt3VarCat() throws IOException, SolmrException
  {
