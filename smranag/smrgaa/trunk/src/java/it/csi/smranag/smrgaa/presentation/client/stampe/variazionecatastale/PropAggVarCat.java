...
public class PropAggVarCat extends SubReport
{
  private final static String TEMPLATE_NAME     = "/it/csi/solmr/etc/anag/stampe/variazionecatastale/PropAggVarCat.srt";
  private final static String CODICE_SUB_REPORT = "PROP_AGG_VAR_CAT";

  public PropAggVarCat() throws IOException, SolmrException
  {
