...
public abstract class StampeGaaServlet extends HttpServlet {
  /**
   * 
   */
  private static final long serialVersionUID = 6997871492197450821L;
                             ...
                             OutputStream outStampa) throws Exception  
  {
    try 
    {
      ...
      HashMap<String, Object> hmParametri = stampaPdf(request, report, anagFacadeclient, gaaFacadeClient, ruoloUtenza);
  ...
  public static ReportElement reportElementClone(ReportSheet report,
                                                   String elID,
                                                   String elIDClone)
  ...
  public static void setBorderRiquadri(DefaultTableLens tblLens)
  {
  ...
  public static String convertiLong(long num)
  {
    if (num == 0)
      return "";
    else
