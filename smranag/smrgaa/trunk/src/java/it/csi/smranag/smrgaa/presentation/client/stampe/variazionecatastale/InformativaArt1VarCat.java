...
public class InformativaArt1VarCat extends SubReport
{
  private final static String TEMPLATE_NAME     = "/it/csi/solmr/etc/anag/stampe/variazionecatastale/InformativaArt1VarCat.srt";
  private final static String CODICE_SUB_REPORT = "INFORMATIVA_ART1_VAR_CAT";

  public InformativaArt1VarCat() throws IOException, SolmrException
  {
