...
import it.csi.smranag.smrgaa.dto.jaxb.fascicolo.SecondoBlocco;
...
public class CodaDichiarazioniSR extends SubReportModol
{
 
  private final static String CODICE_SUB_REPORT = "CODA_DICHIARAZIONI";

  public CodaDichiarazioniSR() throws IOException, SolmrException
  {
      ...
      throws Exception
  {
    ...
    if (vAttestazioni != null)
    {
      ...
      fascicoDigitale.getDichiarazioni().setSecondoBlocco(new SecondoBlocco());
      fascicoDigitale.getDichiarazioni().getSecondoBlocco().setVisibility(true);
      
      fascicoDigitale.getDichiarazioni().getSecondoBlocco().setElencoDichiarazioni(new ElencoDichiarazioni());
      for (int i = 0; i < vAttestazioni.size(); i++)
      {
        ...
        fascicoDigitale.getDichiarazioni().getSecondoBlocco()
