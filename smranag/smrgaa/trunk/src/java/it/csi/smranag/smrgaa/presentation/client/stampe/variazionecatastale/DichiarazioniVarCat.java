...
public class DichiarazioniVarCat extends SubReport
{
  private final static String TEMPLATE_NAME     = "/it/csi/solmr/etc/anag/stampe/variazionecatastale/DichiarazioniVarCat.srt";
  private final static String CODICE_SUB_REPORT = "DICHIARAZIONI_VAR_CAT";

  public DichiarazioniVarCat() throws IOException, SolmrException
  {
