...
public class InformativaArt4VarCat extends SubReport
{
  private final static String TEMPLATE_NAME     = "/it/csi/solmr/etc/anag/stampe/variazionecatastale/InformativaArt4VarCat.srt";
  private final static String CODICE_SUB_REPORT = "INFORMATIVA_ART4_VAR_CAT";

  public InformativaArt4VarCat() throws IOException, SolmrException
  {
