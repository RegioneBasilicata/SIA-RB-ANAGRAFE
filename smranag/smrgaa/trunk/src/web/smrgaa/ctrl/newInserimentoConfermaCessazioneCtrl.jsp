...
<%@ page import="it.csi.smranag.smrgaa.presentation.pdf.PdfNuovaRichiestaCessazione" %>
...
<%
  ...
  String iridePageName = "newInserimentoConfermaCessazioneCtrl.jsp";
  %><%@include file = "/include/autorizzazione.inc" %><%
  
  WebUtils.removeUselessFilter(session, "idAziendaNuova");
  
  String newInserimentoConfermaCessazioneUrl = "/view/newInserimentoConfermaCessazioneView.jsp";  
  String indietroUrl = "/ctrl/newInserimentoRichiestaCessazioneCtrl.jsp";
  String stampaNuovaIscrizioneUrl = "/servlet/StampaNuovaRichiestaCessazioneServlet";
  String stampaNuovaIscrizioneFirmaUrl = "/servlet/StampaNuovaRichiestaCessazioneServlet?param=firma";
  
  
  final String errMsg = "Impossibile procedere nella sezione nuova richiesta cessazione. "+
  ...
  {  
    ...
    PdfNuovaRichiestaCessazione pdfGenerator = new PdfNuovaRichiestaCessazione();
  ...
  {    
    ...
    { 	  
        ...
        SolmrLogger.debug(this, " --- MITTENTE REPLYTO="+mittenteReplyTo);
	      ...
	      try 
	      {
	        oggettoMail = (String)anagFacadeClient.getValoreParametroAltriDati(SolmrConstants.PARAMETRO_OGG_MAIL_RICH_CESS);
	      }
	      catch(SolmrException se) 
	      {
	        SolmrLogger.info(this, " - newInserimentoConfermaCessazioneCtrl.jsp - FINE PAGINA");
	        String messaggio = errMsg+": "+AnagErrors.ERRORE_KO_PARAMETRO_OGG_MAIL_RICH_CESS+".\n"+se.toString();
	        request.setAttribute("messaggioErrore",messaggio);
	        request.setAttribute("pageBack", actionUrl);
	        %>
	          <jsp:forward page="<%= erroreViewUrl %>" />
	      ...
	      try 
	      {
	        testo = (String)anagFacadeClient.getValoreParametroAltriDati(SolmrConstants.PARAMETRO_MAIL_PER_RICH_CESS);
	      }
	      catch(SolmrException se) 
	      {
	        SolmrLogger.info(this, " - newInserimentoConfermaCessazioneCtrl.jsp - FINE PAGINA");
	        String messaggio = errMsg+": "+AnagErrors.ERRORE_KO_PARAMETRO_MAIL_PER_RICH_CESS+".\n"+se.toString();
	        request.setAttribute("messaggioErrore",messaggio);
	        request.setAttribute("pageBack", actionUrl);
	        %>
	          <jsp:forward page="<%= erroreViewUrl %>" />
    ...
    {    
        ...
        SolmrLogger.debug(this, " --- MITTENTE REPLYTO="+mittenteReplyTo);
	      ...
	      try 
	      {
	        oggettoMail = (String)anagFacadeClient.getValoreParametroAltriDati(SolmrConstants.PARAMETRO_OGG_RICH_CESS_A_AZ);
	      }
	      catch(SolmrException se) 
	      {
	        SolmrLogger.info(this, " - newInserimentoConfermaCessazioneCtrl.jsp - FINE PAGINA");
	        String messaggio = errMsg+": "+AnagErrors.ERRORE_KO_PARAMETRO_OGG_RICH_CESS_A_AZ+".\n"+se.toString();
	        request.setAttribute("messaggioErrore",messaggio);
	        request.setAttribute("pageBack", actionUrl);
	        %>
	          <jsp:forward page="<%= erroreViewUrl %>" />
	      ...
	      try 
	      {
	        testo = (String)anagFacadeClient.getValoreParametroAltriDati(SolmrConstants.PARAMETRO_MAIL_RICH_CESS_A_AZ);
	      }
	      catch(SolmrException se) 
	      {
	        SolmrLogger.info(this, " - newInserimentoConfermaCessazioneCtrl.jsp - FINE PAGINA");
	        String messaggio = errMsg+": "+AnagErrors.ERRORE_KO_PARAMETRO_MAIL_RICH_CESS_A_AZ+".\n"+se.toString();
	        request.setAttribute("messaggioErrore",messaggio);
	        request.setAttribute("pageBack", actionUrl);
	        %>
	          <jsp:forward page="<%= erroreViewUrl %>" />
