...
<%
  ...
  String iridePageName = "popParticelleCtrl.jsp";
    %>
      <%@include file = "/include/autorizzazione.inc" %>
    <%

    String popParticelleUrl = "/view/popParticelleView.jsp";
    String inserisciTerrenoCtrlUrl = "/ctrl/inserisciTerrenoCtrl.jsp";
    ...
    if((Validator.isNotEmpty(foglioEvento) && !Validator.isNumericInteger(foglioEvento)) || (Validator.isNotEmpty(particellaEvento) && !Validator.isNumericInteger(particellaEvento)) || comuneVO == null) {
    ...
    // Se lo sono vado a ricercare le particelle in funzione dei filtri di ricerca indicati
      ...
      // Torno alla pagina di inserimento
          %>
            <jsp:forward page= "<%= inserisciTerrenoCtrlUrl %>" >
    ...
    // Vado alla pop-up
    %>
      <jsp:forward page= "<%= popParticelleUrl %>" />
    <%
