...
<%@ page import="it.csi.smranag.smrgaa.presentation.pdf.PdfNuovaRichiestaValidazione" %>
...
<%
  ...
  String iridePageName = "newInserimentoConfermaValidazioneCtrl.jsp";
  %><%@include file = "/include/autorizzazione.inc" %><%
  
  WebUtils.removeUselessFilter(session, "idAziendaNuova");
   
  String newInserimentoConfermaValidazioneUrl = "/view/newInserimentoConfermaValidazioneView.jsp";  
  String indietroUrl = "/ctrl/newInserimentoRichiestaValidazioneCtrl.jsp";
  String stampaNuovaIscrizioneUrl = "/servlet/StampaNuovaRichiestaValidazioneServlet";
  String stampaNuovaIscrizioneFirmaUrl = "/servlet/StampaNuovaRichiestaValidazioneServlet?param=firma";
  
  
  final String errMsg = "Impossibile procedere nella sezione nuova richiesta validazione. "+
    "Contattare l'assistenza comunicando il seguente messaggio: ";
  String actionUrl = "../layout/elencoAziendeRapLegale.htm";
  ...
  {  
    ...
    PdfNuovaRichiestaValidazione pdfGenerator = new PdfNuovaRichiestaValidazione();
  ...
  {    
    ...
    RichiestaAziendaVO richiestaAziendaVO = gaaFacadeClient.getPdfAziendaNuova(
      aziendaNuovaVO.getIdRichiestaAzienda());
      
    gaaFacadeClient.insertFileRichiestaValidazioneAgriWell(aziendaNuovaVO, 
    ...
    String parametroInvioMailRichAz = "";
	  ...
	  {
	    SolmrLogger.info(this, " - newInserimentoConfermaValidazioneCtrl.jsp - FINE PAGINA");
    ...
    {   	  
        ...
        SolmrLogger.debug(this, " --- MITTENTE REPLYTO="+mittenteReplyTo);
	      ...
	      try 
	      {
	        oggettoMail = (String)anagFacadeClient.getValoreParametroAltriDati(SolmrConstants.PARAMETRO_OGG_MAIL_RICH_VAL);
	      }
	      catch(SolmrException se) 
	      {
	        SolmrLogger.info(this, " - newInserimentoConfermaValidazioneCtrl.jsp - FINE PAGINA");
	        String messaggio = errMsg+": "+AnagErrors.ERRORE_KO_PARAMETRO_OGG_MAIL_RICH_VAL+".\n"+se.toString();
	        request.setAttribute("messaggioErrore",messaggio);
	        request.setAttribute("pageBack", actionUrl);
	        %>
	          <jsp:forward page="<%= erroreViewUrl %>" />
	      ...
	      try 
	      {
	        testo = (String)anagFacadeClient.getValoreParametroAltriDati(SolmrConstants.PARAMETRO_MAIL_PER_RICH_VAL);
	      }
	      catch(SolmrException se) 
	      {
	        SolmrLogger.info(this, " - newInserimentoConfermaValidazioneCtrl.jsp - FINE PAGINA");
	        String messaggio = errMsg+": "+AnagErrors.ERRORE_KO_PARAMETRO_MAIL_PER_RICH_VAL+".\n"+se.toString();
	        request.setAttribute("messaggioErrore",messaggio);
	        request.setAttribute("pageBack", actionUrl);
	        %>
	          <jsp:forward page="<%= erroreViewUrl %>" />
    ...
    { 
        ...
        SolmrLogger.debug(this, " --- MITTENTE REPLYTO="+mittenteReplyTo);
	      ...
	      try 
	      {
	        oggettoMail = (String)anagFacadeClient.getValoreParametroAltriDati(SolmrConstants.PARAMETRO_OGG_RICH_VAL_A_AZ);
	      }
	      catch(SolmrException se) 
	      {
	        SolmrLogger.info(this, " - newInserimentoConfermaValidazioneCtrl.jsp - FINE PAGINA");
	        String messaggio = errMsg+": "+AnagErrors.ERRORE_KO_PARAMETRO_OGG_RICH_VAL_A_AZ+".\n"+se.toString();
	        request.setAttribute("messaggioErrore",messaggio);
	        request.setAttribute("pageBack", actionUrl);
	        %>
	          <jsp:forward page="<%= erroreViewUrl %>" />
	      ...
	      try 
	      {
	        testo = (String)anagFacadeClient.getValoreParametroAltriDati(SolmrConstants.PARAMETRO_MAIL_RICH_VAL_A_AZ);
	      }
	      catch(SolmrException se) 
	      {
	        SolmrLogger.info(this, " - newInserimentoConfermaValidazioneCtrl.jsp - FINE PAGINA");
	        String messaggio = errMsg+": "+AnagErrors.ERRORE_KO_PARAMETRO_MAIL_RICH_VAL_A_AZ+".\n"+se.toString();
	        request.setAttribute("messaggioErrore",messaggio);
	        request.setAttribute("pageBack", actionUrl);
	        %>
	          <jsp:forward page="<%= erroreViewUrl %>" />
  ...
  request.setAttribute("valCess", "true");
  request.setAttribute("aziendaNuovaVO", aziendaNuovaVO);
