...
<%@page import="it.csi.solmr.dto.anag.terreni.FiltriUnitaArboreaRicercaVO"%>
<%@page import="it.csi.solmr.exception.SolmrException"%>
<%@page import="it.csi.solmr.etc.anag.AnagErrors"%>
<%@page import="it.csi.solmr.util.WebUtils" %>

<%!
  public static final String  VIEW                 = "/view/unitaArboreeDettaglioPraticheView.jsp";
  private static final String NOME_ORDINE_PER_CUAA = "cuaa";
  private static final String NOME_ORDINE_PER_ANNO = "anno";%>
<%
  String iridePageName = "unitaArboreeDettaglioPraticheCtrl.jsp";
%><%@include file="/include/autorizzazione.inc"%>
<%

  
  AnagAziendaVO anagAziendaVO = (AnagAziendaVO)session.getAttribute("anagAziendaVO");
  final String errMsg = "Impossibile procedere nella sezione unità vitate. "+
    "Contattare l'assistenza comunicando il seguente messaggio: ";
  String actionUrl = "../layout/anagrafica.htm";
  String erroreViewUrl = "/view/erroreView.jsp";
  
  String regimeDettaglioPraticheUV = request.getParameter("regimeDettaglioPraticheUV");
  
  
  
  
  //prima volta che entro resetto la sessione
  if(Validator.isEmpty(regimeDettaglioPraticheUV))
  {
  ...
  catch (Exception e)
  {
    SolmrLogger.info(this,
        "unitaArboreeDettaglioPratiche::service] richiamata pagina con annoPratica non valido. annoPratica="
            + annoPraticaStr);
  }
  ...
  {
    if (session.getAttribute("UNITA_VITATE_ANNI_PRATICHE") == null)
    {
  ...
  {
    String messaggio = (String)AnagErrors.ERRORE_KO_DETTAGLIO_UNAR;
  ...
  try 
  {
    ...
    //storicoParticellaVO = anagFacadeClient.findStoricoParticellaVOByIdParticella(idParticella);
    ...
    if (annoPratica == null)
    {
      ...
      if (anni != null)
      {
        request.setAttribute("UNITA_VITATE_ANNI_PRATICHE", anni);
        session.setAttribute("UNITA_VITATE_ANNI_PRATICHE", anni);
      }
    }
    else
    {
      anni = (String[]) session.getAttribute("UNITA_VITATE_ANNI_PRATICHE");
      if (anni != null)
      {
        request.setAttribute("UNITA_VITATE_ANNI_PRATICHE", anni);
      }
