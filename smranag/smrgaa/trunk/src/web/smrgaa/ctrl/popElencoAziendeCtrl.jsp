...
<%
	...
	String iridePageName = "popElencoAziendeCtrl.jsp";
	%>
  ...
  AnagFacadeClient anagFacadeClient = new AnagFacadeClient();
	String popElencoAziendeUrl = "/view/popElencoAziendeView.jsp";
  ...
  if(Validator.isEmpty(operazione))
  {
    ...
    try 
    {
      ...
      if("AziendeCollegate".equalsIgnoreCase(provenienza))
      {
        attive = true;
      }      
      ...
      else
      {
        ...
        //quindi devo eliminare in sessione una valore per
        //bloccare l'inserimento a mano dell'azienda
    ...
    {
      SolmrLogger.info(this, " - popElencoAziendeCtrl.jsp - FINE PAGINA");
