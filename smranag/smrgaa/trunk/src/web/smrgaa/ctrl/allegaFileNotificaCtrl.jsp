...
<%
  ...
  String iridePageName = "allegaFileNotificaCtrl.jsp";
  %>
    <%@include file="/include/autorizzazione.inc"%>
  <%
  
  SolmrLogger.info(this, " - allegaFileNotificaCtrl.jsp - INIZIO PAGINA");
  
  final String errMsg = "Impossibile procedere nella sezione notifca/allega file."+
    "Contattare l'assistenza comunicando il seguente messaggio: ";
  
  String erroreViewUrl = "/view/erroreView.jsp";
  String VIEW = "../view/allegaFileNotificaView.jsp";
  String REFRESH = "../layout/allegaFileNotifica.htm?operazione=refresh";
  ...
  try
  {
    ...
    {
      SolmrLogger.info(this, " - allegaFileNotificaCtrl.jsp - FINE PAGINA");
    ...
    if (Validator.isEmpty(operazione))
    {      
      WebUtils.removeUselessFilter(session, "notificaModificaVO"); //rimuovere dalla sessione vElencoFileAllegati e fileAllegatoVO
      ...
      vElencoFileAllegati = gaaFacadeClient.getElencoFileAllegatiNotifica(idDocumento);
    ...
    { 
      ...
      gaaFacadeClient.deleteFileAllegatoNotifica(new Long(idAllegato), 
    ...
    { 
      ...
      vElencoFileAllegati = gaaFacadeClient.getElencoFileAllegatiNotifica(allegatoDocumentoVO.getIdDocumento());
    ...
    else if ("conferma".equals(operazione))
    {
        ...
        if (errors.size() == 0 ) 
        {
          gaaFacadeClient.insertFileAllegatoNotifica(allegatoDocumentoVO);
