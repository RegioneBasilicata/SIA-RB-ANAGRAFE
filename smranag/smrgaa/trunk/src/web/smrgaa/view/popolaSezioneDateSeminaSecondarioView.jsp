...
<%
	...
	java.io.InputStream layout = application.getResourceAsStream("/layout/popolaSezioneDateSeminaSecondario.htm");
  ...
  {  
      ...
      { 
        ...
        if(catalogoMatriceSeminaVO != null)
        {
          ...
          htmpl.set("dataInizioDestinazioneSec", DateUtils.formatDateNotNull(dataInizioDestinazione));
          htmpl.set("dataFineDestinazioneSec", DateUtils.formatDateNotNull(dataFineDestinazione));
        }
      }
	...
	{
	  htmpl.set("readOnlyDataInizioDestinazioneSec", "readOnly=\"true\"", null);
	  htmpl.set("readOnlyDataFineDestinazioneSec", "readOnly=\"true\"", null);
	}
