...
<%!
  private static final String NEXT_PAGE_OK="../layout/terreniVerifica_ok.htm";
  private static final String NEXT_PAGE_ANOMALIA="../layout/terreniVerifica_ko.htm";
...
<%
  Htmpl htmpl = HtmplFactory.getInstance(application).getHtmpl("/layout/terreniVerifica_attendere.htm");
  ...
  try
  {
    ...
    String ris=client.controlliVerificaPLSQL(
      anagVO.getIdAzienda(),anno,new Integer(SolmrConstants.get("ID_GRUPPO_CONTROLLO_TERRENI").toString()), ruoloUtenza.getIdUtente());
    if (ris.equals("N"))
    {
