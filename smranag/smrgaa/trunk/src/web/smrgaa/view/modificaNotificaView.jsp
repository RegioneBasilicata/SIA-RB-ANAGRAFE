...
<%
 ...
 java.io.InputStream layout = application.getResourceAsStream("/layout/modificaNotifica.htm");
 ...
 <%
  ...
  htmpl.set("descTipologiaNotifica", notificaModificaVO.getDescTipologiaNotifica());
  
  if(Validator.isNotEmpty(notificaModificaVO.getDescrizione()))
    htmpl.set("descrizione", notificaModificaVO.getDescrizione());
  ...
  {
    htmpl.newBlock("blkModificaCategoria");
    Vector<TipoCategoriaNotificaVO> vCategoriaNotifica = (Vector<TipoCategoriaNotificaVO>)request.getAttribute("vCategoriaNotifica");
	  
	  String idCategoriaNotifica = "";
	  if(request.getParameter("regimeModificaNotifica") != null)
	  {
	    idCategoriaNotifica = request.getParameter("idCategoriaNotifica");
	  }
	  else
	  {
	    idCategoriaNotifica = notificaModificaVO.getIdCategoriaNotifica().toString();
	  }
    ...
    for(int i=0; i<vCategoriaNotifica.size(); i++)
    {
      ...
      if(tipoCategoriaNotificaVO.getIdTipologiaNotifica().intValue() 
        == notificaModificaVO.getIdTipologiaNotifica().intValue())
      {
	      htmpl.newBlock("blkModificaCategoria.blkCategoriaNotifica");
	      htmpl.set("blkModificaCategoria.blkCategoriaNotifica.idCategoriaNotifica", ""+tipoCategoriaNotificaVO.getIdCategoriaNotifica());
	      htmpl.set("blkModificaCategoria.blkCategoriaNotifica.descCategoriaNotifica", tipoCategoriaNotificaVO.getDescrizione());
	      ...
	      {
	        htmpl.set("blkModificaCategoria.blkCategoriaNotifica.selected", "selected=\"selected\"", null);    
	      }
	    }
    }
  ...
  {
    htmpl.newBlock("blkFissaCategoria");
    htmpl.set("blkFissaCategoria.descCategoriaNotifica", notificaModificaVO.getDescCategoriaNotifica());
  }
