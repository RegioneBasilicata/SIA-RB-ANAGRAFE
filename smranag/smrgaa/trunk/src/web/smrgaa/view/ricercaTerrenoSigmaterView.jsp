...
<%
  SolmrLogger.debug(this, " - ricercaTerrenoSigmaterView.jsp - INIZIO PAGINA");
 	Htmpl htmpl = HtmplFactory.getInstance(application).getHtmpl("/layout/ricercaTerrenoSigmater.htm");
  ...
  try
  {
    ...
    if (storicoParticellaVO!=null)
    {
      ...
      //per il GIS
      htmpl.set("idStoricoParticella", storicoParticellaVO.getIdStoricoParticella().toString());
    ...
    else
    {
      ...
      if (dettTerreno!=null)
      {
        ...
        Titolarita titolarita[]=(Titolarita[])request.getAttribute("titolarita");
  ...
  SolmrLogger.debug(this, " - ricercaTerrenoSigmaterView.jsp - FINE PAGINA");
%>
