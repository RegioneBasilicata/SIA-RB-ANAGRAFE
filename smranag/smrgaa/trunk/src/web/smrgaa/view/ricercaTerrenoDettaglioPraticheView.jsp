...
<%!public static final String LAYOUT                  = "/layout/ricercaTerrenoDettaglioPratiche.htm";
...
<%
  SolmrLogger.debug(this, "[RicercaTerrenoDettaglioPraticheView:service] BEGIN.");
...
<%
  ...
  // Combo degli anni
  String anni[] = (String[]) request.getSession().getAttribute("RICERCA_TERRENI_ANNI_PRATICHE");
  /*if (anni == null)
  {
    return;
  }*/
  ...
  for (int i = 0; i < len; ++i)
  {
    ...
    htmpl.set("blkElenco.blkRiga.cuaa", rigaVO.getCuaa());
    htmpl.set("blkElenco.blkRiga.denominazione", rigaVO.getDenominazione());
...
%><%=htmpl.text()%>
<%
  SolmrLogger.debug(this, "[RicercaTerrenoDettaglioPraticheView:service] END.");
%><%!
