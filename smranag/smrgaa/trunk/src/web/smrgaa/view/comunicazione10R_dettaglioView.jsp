...
<%
  ...
  Htmpl htmpl = HtmplFactory.getInstance(application).getHtmpl("/layout/comunicazione10R_dettaglio.htm");
  ...
  if(vTotCom10r !=null) //esiste almeno una dichiarazione 10r collegata ad una ute
  {
    ...
    for(int i=0;i<vTotCom10r.size();i++)
    {
      ...
      Vector<EffluenteVO> vEffluenti = (Vector<EffluenteVO>)hCom10R.get("vEffluenti");
      if(vEffluenti !=null)
      {
        ...
        {
          EffluenteVO effVO = (EffluenteVO)vEffluenti.get(j);
      ...
      if(vAcquisizioni != null)
      {
        ...
        {
          EffluenteCesAcqVO effVO = (EffluenteCesAcqVO)vAcquisizioni.get(j);
