...
<%
  SolmrLogger.debug(this, " - manodoperaNewView.jsp - INIZIO PAGINA");

  java.io.InputStream layout = application.getResourceAsStream("/layout/manodoperaNew.htm");
  ...
  SolmrLogger.debug(this, " - manodoperaNewView.jsp - FINE PAGINA");
%>
<%= htmpl.text()%>
