...
<%
  ...
  Htmpl htmpl = HtmplFactory.getInstance(application).getHtmpl("/layout/dichiarazioneNoModifiche.htm");
  ...
  String messaggio=(String)request.getAttribute("messaggioNoDichiarazione");

  if ("".equals(messaggio) || (messaggio==null))
  {
    htmpl.set("messaggio","Non sono state effettuate modifiche rispetto all'ultima dichiarazione di consistenza");
  }
  else
  {
