...
<%
  ...
  java.io.InputStream layout = application.getResourceAsStream("/layout/inserisciTerreno.htm");
  ...
  String indietro = (String)request.getAttribute("indietro");
  ...
  if(elencoStoricoEvento != null && elencoStoricoEvento.length > 0) 
  {
    ...
    for(int i = 0; i < elencoStoricoEvento.length; i++) 
    {
      ...
      {
        htmpl.set("blkParticelleEvento.blkElencoParticelle.checkedParticellaDaCessare", 
